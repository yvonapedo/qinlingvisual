...
function show_ecological_color(d, name, data){
    ...
    //     // d3.selectAll('#arrow_id').remove();
    //     // d3.selectAll('#arrow_id').remove();
    //     show_name = "Average Soil humanity"
        ...
        success: function (data) {
            ...
            regions.on("mouseover", function (d) {
                ...
                if (map_end !== undefined){
                    ...
                    // if (map_end === "rhu") geographic_element= 'Average Soil humanity:' + ((data["data"][geographic_num]["sw_5"] + data["data"][geographic_num]["sw_10"] + data["data"][geographic_num]["sw_40"] + data["data"][geographic_num]["sw_200"]) * 25).toFixed(2) + "%";
                    if ((map_end === "wnd")){
                ...
                // $('#humanity').val('Average Soil humanity:'+ ((geographic_weather["sw_5"] + geographic_weather["sw_10"] + geographic_weather["sw_40"] + geographic_weather["sw_200"]) *25).toFixed(2) + '%');
                $('#wind_direction').val('Wind direction:'+ geographic_weather["wnd"].toFixed(2) + '°');
                $('#wind_speed').val('Wind speed:'+ geographic_weather["wns"].toFixed(2) + 'km/h');
                $('#100m_wind_direction').val('100m Wind direction:'+ geographic_weather["wnd_100m"].toFixed(2) + '°');
                $('#100m_wind_speed').val('100m Wind speed:'+ geographic_weather["wns_100m"].toFixed(2) + 'km/h');
                $('#Gust_wind_speed').val('Gust wind speed:'+ geographic_weather["gust"].toFixed(2) + 'km/h');
